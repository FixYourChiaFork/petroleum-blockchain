...
# echo "Sign ========================================================================"
# electron-osx-sign Petroleum-darwin-x64/Petroleum.app --platform=darwin \
...
# notarize-cli --file=$DMG_NAME.dmg --bundle-id net.petroleum.blockchain --username "williejonagvio38@gmail.com" --password "mrdo-yfcr-intb-eyxr"
