...
def show_plots(root_path: Path):
    ...
    print(
        "Add with 'petroleum plots add -d [dir]' and remove with"
        + " 'petroleum plots remove -d [dir]'"
        + " Scan and check plots with 'petroleum plots check'"
    )
    print()
...
def plots_cmd(ctx: click.Context):
    ...
    if not root_path.is_dir():
        raise RuntimeError("Please initialize (or migrate) your config directory with 'petroleum init'")
