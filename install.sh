...
if [ "$(uname -m)" = "armv7l" ]; then
  echo ""
	echo "WARNING:"
	echo "The Petroleum Blockchain requires a 64 bit OS and this is 32 bit armv7l"
	echo "For more information, see"
	echo "https://github.com/petroleum-network/petroleum-blockchain/wiki/Raspberry-Pi"
	echo "Exiting."
	exit 1
fi
# Get submodules
...
echo ""
echo "Petroleum blockchain install.sh complete."
...
echo "https://github.com/petroleum-network/petroleum-blockchain/wiki/Quick-Start-Guide"
echo ""
